...
//    }
    ...
    viewModel.changeDate.observe(owner){
        it.dataCurrent?.let {
            datavalue = it
        }
        it.waterId?.let {
        ...
        it.drained_of_water?.let {
            quantity_drained_water = it.toString()
        }
        it.water_is_drunk?.let {
            amount_water = it.toString()
        }
    }
    ...
    Dialog(
        ...
        Card(
            ...
            Column(
                ...
                Text(text = "Изменение выпитой воды:",
