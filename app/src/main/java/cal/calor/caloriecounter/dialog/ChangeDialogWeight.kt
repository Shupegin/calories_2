...
@Composable
fun ChangeDialogWeight(dialogState: MutableState<Boolean>, weightViewModel: WeightViewModel, owner : LifecycleOwner){
    ...
    weightViewModel.changeDate.observe(owner){
        it?.let {
            it.id?.let { id = it  }
            weight = it.weight.toString()
            hip = it.hip.toString()
            waist = it.waist.toString()
            breast = it.breast.toString()
            biceps = it.biceps.toString()
            belly = it.belly.toString()
            buttocks = it.buttocks.toString()
        }
    }
        ...
        onDismissRequest = {
            ...
            Card(modifier = Modifier
                ...
                Column(modifier = Modifier.padding(20.dp),
                    ...
                    Text(text = "Измените вашы данные",
